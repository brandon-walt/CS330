...
void SceneManager::SetupSceneLights(){
	...
	m_pShaderManager->setVec3Value("directionalLight.ambient", 0.3f, 0.25f, 0.2f);
	m_pShaderManager->setVec3Value("directionalLight.diffuse", 0.8f, 0.7f, 0.6f);
	m_pShaderManager->setVec3Value("directionalLight.specular", 0.5f, 0.5f, 0.5f);
	m_pShaderManager->setBoolValue("directionalLight.bActive", true);

	// Point light
	m_pShaderManager->setVec3Value("pointLights[1].position", 5.0f, 5.0f, 0.0f); 
	m_pShaderManager->setVec3Value("pointLights[1].ambient", 0.2f, 0.2f, 0.15f);
	m_pShaderManager->setVec3Value("pointLights[1].diffuse", 0.9f, 0.8f, 0.7f);
...
void SceneManager::LoadSceneTextures()
{
	...
	// Loaded textures 
	bReturn = CreateGLTexture("textures/black_marble.jpg", "mug");
	bReturn = CreateGLTexture("textures/wood.jpg", "desk");
...
void SceneManager::RenderScene()
{
	...
	// Tapered Cylinder for body of mug
	...
	// Half torus for handle of mug
	scaleXYZ = glm::vec3(0.5f, 0.5f, 0.5f); 
	XrotationDegrees = 0.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = -100.0f; 
	positionXYZ = glm::vec3(0.75f, 1.25f, 0.0f);
	SetTransformations(
		scaleXYZ,
		XrotationDegrees,
		YrotationDegrees,
